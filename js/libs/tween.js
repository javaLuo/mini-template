var now,
  Easing = {
    ...
    Bounce: {
      ...
      InOut: function (t) {
        return t < 0.5 ? 0.5 * Easing.Bounce.In(2 * t) : 0.5 * Easing.Bounce.Out(2 * t - 1) + 0.5;
      },
    },
  },
  now$1 = (now =
  ...
  Interpolation = {
    ...
    Bezier: function (t, e) {
      for (var n = 0, i = t.length - 1, r = Math.pow, o = Interpolation.Utils.Bernstein, s = 0; s <= i; s++) n += r(1 - e, i - s) * r(e, s) * t[s] * o(i, s);
      return n;
    },
  ...
  Tween = (function () {
    ...
    return (
      ...
      (t.prototype.start = function (t) {
        ...
        return (this._isPlaying = !0), (this._isPaused = !1), (this._onStartCallbackFired = !1), (this._isChainStopped = !1), (this._startTime = void 0 !== t ? ("string" == typeof t ? now$1() + parseFloat(t) : t) : now$1()), (this._startTime += this._delayTime), this._setupProperties(this._object, this._valuesStart, this._valuesEnd, this._valuesStartRepeat), this;
      }),
      (t.prototype._setupProperties = function (t, e, n, i) {
        for (var r in n) {
          ...
          if ("undefined" !== a && "function" !== a) {
            ...
            if (("object" !== a && !s) || !o || u) void 0 === e[r] && (e[r] = o), s || (e[r] *= 1), (i[r] = u ? n[r].slice().reverse() : e[r] || 0);
            else {
      ...
      (t.prototype.pause = function (t) {
        return void 0 === t && (t = now$1()), this._isPaused || !this._isPlaying ? this : ((this._isPaused = !0), (this._pauseStart = t), this._group && this._group.remove(this), this);
      }),
      (t.prototype.resume = function (t) {
        return void 0 === t && (t = now$1()), this._isPaused && this._isPlaying ? ((this._isPaused = !1), (this._startTime += t - this._pauseStart), (this._pauseStart = 0), this._group && this._group.add(this), this) : this;
      }),
      ...
      (t.prototype.update = function (t, e) {
        if ((void 0 === t && (t = now$1()), void 0 === e && (e = !0), this._isPaused)) return !0;
        var n,
          i,
        ...
        if ((this._updateProperties(this._object, this._valuesStart, this._valuesEnd, o), this._onUpdateCallback && this._onUpdateCallback(this._object, i), 1 === i)) {
          ...
          for (var s = 0, a = this._chainedTweens.length; s < a; s++) this._chainedTweens[s].start(this._startTime + this._duration);
  ...
  exports = { Easing: Easing, Group: Group, Interpolation: Interpolation, now: now$1, Sequence: Sequence, nextId: nextId, Tween: Tween, VERSION: VERSION, getAll: getAll, removeAll: removeAll, add: add, remove: remove, update: update };
